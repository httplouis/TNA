    ...
    <div className="min-h-screen bg-[var(--bg-page)] text-[var(--text-base)] overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <Image
              ...
              priority
            />
            <div className="h-5 w-px bg-white/15 mx-0.5 sm:mx-1 flex-shrink-0" />
            <a href="https://xploreph.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity flex items-center h-14 sm:h-16 flex-shrink-0">
              <Image
            ...
            <span className="hidden sm:inline text-xs text-white/60 font-medium">TNA Portal</span>
          </div>
          <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
            <ThemeToggle />
            <Link
              href="/admin"
              className="text-xs text-[var(--text-muted)] hover:text-[var(--text-base)] transition-colors flex items-center gap-1"
            >
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-24 px-5 sm:px-6">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] sm:w-[700px] h-[300px] sm:h-[400px] bg-[#1d6eb5]/15 rounded-full blur-[100px]" />
        </div>

        <div className="relative max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-[#1d6eb5]/40 bg-[#1d6eb5]/10 text-[10px] sm:text-xs font-semibold text-[#60a5fa] uppercase tracking-widest mb-5 sm:mb-6 animate-fade-in">
            Training Needs Assessment
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-5 sm:mb-6 animate-fade-in-up">
            Discover Your{" "}
          ...
          <p className="text-base sm:text-lg text-[var(--text-muted)] max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed animate-fade-in-up delay-100">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 animate-fade-in-up delay-200">
            <Link
              href="/survey"
              id="cta-start-survey"
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 sm:py-4 rounded-xl font-semibold text-sm bg-[#1d6eb5] hover:bg-[#1a5fa0] text-[var(--text-base)] shadow-xl shadow-blue-900/30 transition-all duration-200 hover:-translate-y-0.5"
            >
              Take the Assessment
            ...
            <a
              href="#how-it-works"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 sm:py-4 rounded-xl font-semibold text-sm border border-[var(--border)] text-[var(--text-base)] hover:border-white/20 transition-all duration-200"
            >
              How it works
            </a>
          </div>
          ...
          {/* Quick stats */}
          <div className="mt-12 sm:mt-16 grid grid-cols-3 gap-4 sm:gap-6 max-w-xs sm:max-w-lg mx-auto animate-fade-in-up delay-300">
            {[
              ...
              <div key={label} className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-[var(--text-base)]">{val}</div>
                <div className="text-[10px] sm:text-xs text-[var(--text-muted)] mt-1 uppercase tracking-wider">{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 px-5 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-[var(--text-muted)] text-sm mb-6 sm:mb-8">Across 5 self-assessment sections</p>
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
            {CATEGORIES.map(({ name }) => (
              <span
                key={name}
                className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-[var(--border)] bg-[var(--bg-surface)] text-xs sm:text-sm text-[var(--text-base)]"
              >
                {name}
              </span>
            ))}
      ...
      {/* ── How it Works ─────────────────────────────────────── */}
      <section id="how-it-works" className="py-14 sm:py-20 px-5 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-base)] mb-3">How It Works</h2>
      ...
      {/* ── Feature Cards ─────────────────────────────────────── */}
      <section className="py-14 sm:py-20 px-5 sm:px-6 bg-[var(--bg-card)]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-base)] mb-3">Why This Assessment?</h2>
            <p className="text-[var(--text-muted)] max-w-xl mx-auto text-sm sm:text-base">
      ...
      <section className="py-14 sm:py-24 px-5 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="glass-card p-7 sm:p-12 border-[#1d6eb5]/30 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[var(--text-base)] mb-3">Ready to get started?</h2>
              <p className="text-[var(--text-muted)] mb-7 sm:mb-8 max-w-md mx-auto text-sm sm:text-base">
                &quot;The goal is to help identify training needs accurately while maintaining control over the results before releasing them.&quot;
              </p>
              <Link
                href="/survey"
                id="cta-bottom-start"
                className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-3.5 sm:py-4 rounded-xl font-semibold bg-[#1d6eb5] hover:bg-[#1a5fa0] text-[var(--text-base)] shadow-xl shadow-blue-900/30 transition-all duration-200 hover:-translate-y-0.5"
              >
      ...
      {/* ── Footer ───────────────────────────────────────────── */}
      <footer className="border-t border-[var(--border)] py-7 sm:py-8 px-5 sm:px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Image
              ...
              width={90}
              height={24}
              className="h-5 sm:h-6 w-auto object-contain opacity-50"
            />
            <div className="h-4 w-px bg-white/10" />
            <a href="https://xploreph.vercel.app" target="_blank" rel="noopener noreferrer" className="hover:opacity-100 transition-opacity flex items-center h-8">
              <Image
                src="/xplore-logo-white.png"
                alt="Xplore Philippines"
                width={80}
                height={28}
                className="h-5 sm:h-6 w-auto object-contain opacity-50 hover:opacity-100 transition-opacity"
              />
            </a>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center">
            <p className="text-xs text-slate-500">TNA Portal — Microsoft Excel Corporate Training</p>
            <Link href="/privacy" className="text-xs text-slate-500 hover:text-[var(--text-muted)] transition-colors underline underline-offset-2">Privacy Notice</Link>
          </div>
        </div>
      </footer>
    </div>
