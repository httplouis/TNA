    ...
    <div className="min-h-screen bg-[#0c1220] text-slate-100">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Data Privacy Notice</h1>
          <p className="text-slate-400 text-sm">Effective Date: January 1, 2025 · Informatics Holdings Philippines</p>
        </div>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-slate-300">
          ...
          <section>
            ...
            <p>
              Informatics Holdings Philippines (<strong className="text-white">"Informatics," "we," "our," or "us"</strong>) is
              committed to protecting your personal data in accordance with the <strong className="text-white">Data Privacy Act of
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">2. Personal Information We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">3. Purpose of Data Collection</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">4. Legal Basis for Processing</h2>
            <p>
              We process your personal data based on your <strong className="text-white">voluntary and informed consent</strong>,
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">5. Data Sharing and Disclosure</h2>
            <p className="mb-3">
              Your personal data will <strong className="text-white">not</strong> be sold, rented, or shared with third parties
          ...
          <section>
            ...
            <p>
              We retain your personal data for a period of <strong className="text-white">three (3) years</strong> from the date
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">8. Your Rights as a Data Subject</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">9. Contact Information</h2>
            <p className="mb-4">
              For questions, concerns, or to exercise your data privacy rights, please contact our Data Protection Officer:
            </p>
            <div className="glass-card p-5 space-y-3">
              <p className="font-semibold text-white">Informatics Holdings Philippines</p>
          ...
          <section>
            <h2 className="text-base font-bold text-white mb-3">10. Changes to This Notice</h2>
            <p>
        ...
        <div className="mt-10 pt-8 border-t border-white/5 text-center">
          <Link
            href="/survey"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold bg-[#1d6eb5] hover:bg-[#1a5fa0] text-white shadow-lg shadow-blue-900/30 transition-all hover:-translate-y-0.5"
          >
